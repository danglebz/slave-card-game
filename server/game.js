// game.js — ตรรกะเกมไพ่สลาฟ (กติกามาตรฐาน) แบบ pure ทดสอบ/ตรวจสอบฝั่ง server ได้
//
...
export const SUITS = ['♣', '♦', '♥', '♠'];
export const SUIT_NAMES = ['ดอกจิก', 'ข้าวหลามตัด', 'โพแดง', 'โพดำ'];
...
export function canBeat(current, candidate) {
...
export function playMode(current, candidate) {
  if (!current) {
