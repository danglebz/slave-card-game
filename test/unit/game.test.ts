...
// helpers to build a card/combo from an id "r.s"
...
describe('bombPower', () => {
  it('จัดลำดับความแรงข้ามชนิดถูกต้อง', () => {
    ...
    // quad beats straight5 but still loses to straight6
    expect(bombPower(quad)).toBe(5);
...
describe('anyLegalMove — เช็คว่ามีไพ่ลงได้ไหม (คุม auto-pass)', () => {
  ...
  it('กองเรียง 3 ใบ: มีเรียงดอกเดียวสูงกว่า → ลงได้', () => {
    // pile 4-5-6 ♦ ; hand has 7-8-9 ♣ (flush straight, length 3) → beats it
