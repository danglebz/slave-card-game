...
History up to v1.23.0 was generated by [commit-and-tag-version](https://github.com/absolute-version/commit-and-tag-version). From here on, releases are cut automatically by [semantic-release](https://semantic-release.gitbook.io/) — see [GitHub Releases](https://github.com/danglebz/slave-card-game/releases) for release notes going forward (this file is no longer updated automatically).
