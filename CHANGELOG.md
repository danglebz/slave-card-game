...
* **release:** commit version write-back using a PAT that bypasses branch protection ([cc3a3ba](https://github.com/danglebz/slave-card-game/commit/cc3a3ba18ff389ce19118ddde040c8b7eebb0ba2))

# Changelog

History up to v1.23.0 was generated by [commit-and-tag-version](https://github.com/absolute-version/commit-and-tag-version). From here on, releases are cut automatically by [semantic-release](https://semantic-release.gitbook.io/), which also keeps this file up to date.
